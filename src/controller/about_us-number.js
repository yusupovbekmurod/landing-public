import scoial from "../models/about_us-number.js";
...
class AboutUsNumber {
    ...
    async post(req, res) {
        try {
            let { title, numbers, imageLink } = req.body;
        ...
        try {
            ...
            const obj = {
                $set: {
                    ...
                    numbers: numbers ? numbers : data.numbers,
...
export default new AboutUsNumber();
